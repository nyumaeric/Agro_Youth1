...
// //       setTimeout(() => {
// //         router.push("/dashboard/investors"); // Redirect back to projects
// //       }, 2000);
// //     }
// //   }, [projectId, router]);
...
// //         <Card>
// //           <CardHeader>
// //             <CardTitle className="text-2xl">Donation Application</CardTitle>
// //             <CardDescription>
// //               Fill out the form below to apply for funding for your project
// //             </CardDescription>
// //           </CardHeader>
// //           <CardContent>
...
// //               <div className="space-y-2">
// //                 <Label>
// //                   Certificates (PDF only) <span className="text-red-500">*</span>
// //                 </Label>
...
//     if (!formData.email || !formData.projectTitle || !formData.projectDescription || 
//         !formData.projectGoals || !formData.budgetAmount || !formData.duration || 
...
//                       Budget Amount <span className="text-emerald-600">*</span>
//                     </Label>
//                     <div className="relative">
//                       <Input
//                         id="budgetAmount"
...
//                   <span className="text-gray-500 text-xs ml-2">(PDF only)</span>
//                 </Label>
